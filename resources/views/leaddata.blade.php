...
<div class="container register-form">
    <form action="leaddata" method="GET">
    @csrf
            <div class="form">
                <div class="note">
                ...
                <div class="form-content">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="leaddata" id="hleaddata" class="form-control" style="width:350px">
                        <option value="" hidden>Select Option</option>
                        <option value="internship" >Internship</option>
                         <option value="service" >Services</option>
                         <option value="course">Course</option>
                        </select>
                        <select name="lead_course" class="form-control" style="width:350px" value="internship" id="internship" hidden>
                        @foreach($intern as $try)
                        <option name="lead_course" id="hlead_course" value="{{$try->lead_course}}" >{{$try->lead_course}}</option>
                        @endforeach
                                            
                        </select>
                        <select  name="lead_course"  class="form-control" style="width:350px;" value="service" id="service" hidden>
                        @foreach($service as $try)
                        <option name="lead_course" id="hlead_course"  value="{{$try->lead_course}}"  >{{$try->lead_course}}</option>
                        @endforeach
                                            
                        </select>
                        <select name="lead_course" class="form-control" style="width:350px;" value="course" id="course" hidden>
