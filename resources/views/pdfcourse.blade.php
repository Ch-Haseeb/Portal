...
<body>
<a id="btn"class="btn btn-primary" href="{{route('view.product',[$p['0']->lead,$p['0']->course,$p['0']->month])}}" >Download PDF</a>
...
<div id="inline">
  <div id="first">
	...
	<h2 id="p1">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Devicon</h2>
	<p id="p1"> &nbsp &nbsp &nbsp  &nbsp  Address: Opposite KFC Near Bank of Punjab, RYK</p>
	<p id="p1"> &nbsp &nbsp &nbsp &nbsp   Phone: 03030336939</p>
	<table class="center">
  <tr>
...
<div id="second">
<h2 id="p1"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Devicon</h2>
	<p id="p1"> &nbsp &nbsp  &nbsp &nbsp &nbsp  Address: Opposite KFC Near Bank of Punjab, RYK</p>
	<p id="p1">&nbsp &nbsp &nbsp &nbsp &nbsp  Phone: 03030336939</p>
	<table class="center">
  <tr>
    <td width="100px">VN:</td>
    <td width="110px">10</td>
