      ...
      <div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            ...
            <div class="dark-logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{url('/assets/images/logo/dark-logo.png')}}" alt=""></a></div>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown"><i data-feather="message-square"></i>
                <ul class="chat-dropdown onhover-show-div">
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="{{url('/assets/images/user/4.jpg')}}" alt="">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="{{url('/assets/images/user/1.jpg')}}" alt="">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="{{url('/assets/images/user/2.jpg')}}" alt="">
                        ...
                        <div class="table-responsive">
                          ...
                          <table class="table table-bordernone">                                         
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="media"><img class="img-fluid rounded-circle" src="{{url('/assets/images/dashboard/product-1.png')}}" alt="" data-original-title="" title="">
                                ...
                                <td><img class="img-fluid" src="{{url('/assets/images/dashboard/graph-1.png')}}" alt="" data-original-title="" title=""></td>
                                <td>
                                  <p>$210326</p>
                                </td>
                                <td>
                              ...
                              <tr>
                                <td>
                                  <div class="media"><img class="img-fluid rounded-circle" src="{{url('/assets/images/dashboard/product-2.png')}}" alt="" data-original-title="" title="">
                                ...
                                <td><img class="img-fluid" src="{{url('//assets/images/dashboard/graph-2.png')}}" alt="" data-original-title="" title=""></td>
                                <td>
                                  <p>$548526</p>
                                </td>
                                <td>
                              ...
                              <tr>
                                <td>
                                  <div class="media"><img class="img-fluid rounded-circle" src="{{url('//assets/images/dashboard/product-3.png')}}" alt="" data-original-title="" title="">
                                ...
                                <td><img class="img-fluid" src="{{url('//assets/images/dashboard/graph-3.png')}}" alt="" data-original-title="" title=""></td>
                                <td>
                                  <p>$589565</p>
                                </td>
                                <td>
                              ...
                              <tr>
                                <td>
                                  <div class="media"><img class="img-fluid rounded-circle" src="{{url('/assets/images/dashboard/product-4.png')}}" alt="" data-original-title="" title="">
                                ...
                                <td><img class="img-fluid" src="{{url('/assets/images/dashboard/graph-4.png')}}" alt="" data-original-title="" title=""></td>
                                <td>
                                  <p>$125424 </p>
                                </td>
                                <td>
                              ...
                              <tr>
                                <td>
                                  <div class="media"><img class="img-fluid rounded-circle" src="{{url('/assets/images/dashboard/product-5.png')}}" alt="" data-original-title="" title="">
                                ...
                                <td><img class="img-fluid" src="{{url('/assets/images/dashboard/graph-5.png')}}" alt="" data-original-title="" title=""></td>
                                <td>
                                  <p>$112103</p>
                                </td>
                                <td>
     ...
     &lt;table class="table table-bordernone"&gt;
       ...
       &lt;tbody&gt;
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="{{url('/assets/images/dashboard/product-1.png')}}" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src=""{{url('/assets/images/dashboard/product-2.png')}}" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="{{url('//assets/images/dashboard/product-3.png')}}" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="{{url('/assets/images/dashboard/graph-3.png')}}" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$589565&lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="{{url('/assets/images/dashboard/product-4.png')}}" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
           ...
           &lt;/td&gt;
           &lt;td&gt;
             &lt;img class="img-fluid" src="{{url('/assets/images/dashboard/graph-4.png')}}" alt="" data-original-title="" title=""&gt;
           &lt;/td&gt;
           &lt;td&gt;
             &lt;p&gt;$125424 &lt;/p&gt;
           &lt;/td&gt;
         ...
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid rounded-circle" src="{{url('/assets/images/dashboard/product-5.png')}}" alt="" data-original-title="" title=""&gt;
               &lt;div class="media-body"&gt;
