...
<!--                         
                        ...
                        <img src= "{{asset ('/img/wordpress.png') }}"class="responsive-img" >
						...
						<a href="buyservice">Enroll Now</a>
				 ...
				 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <img src= "{{asset ('/img/graphic.png') }}"class="responsive-img" >
						...
						<a href="buyservice">Buy Services</a>
				 ...
				 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <img src= "{{asset ('/img/developement.png') }}"class="responsive-img" >
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				 ...
				 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <img src= "{{asset ('/img/social.png') }}"class="responsive-img" >
				 ...
				 <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <img src= "{{asset ('/img/andriod.png') }}"class="responsive-img" >
