  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="tranning">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Tranning</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="marketer">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Marketer</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="prodview">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Lead Data</span>
          </a>
        </li>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Leads</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Leads</h6>
        </nav>
...
<div class="container register-form">
  ...
  @csrf
                ...
                <div class="form-content">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Your Gmail" id="gmail" name="gmail"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Your CNIC NO " value="" id="cnic" name="cnic"/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Your Father/Guardian Name" id="father_name" name="father_name"/>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Your Phone No " value="" id="mobile" name="mobile"/>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Your Degree" id="degree" name="degree"/>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Your Uni Name" id="uni" name="uni"/>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Deal Done" id="deal_done" name="deal_done"/>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Any Deal" id="deal_tell" name="deal_tell"/>
                            </div>                          
                               </div>
                               ...
                               <div class="col-md-6">
                            <div class="form-group">
                            <select name="about_devicon" id="about_devicon" class="form-control" >
                        ...
                        <option value="Word Of Mouth" name="about_devicon" id="about_devicon">Word Of Mouth</option>
                         ...
                         <option value="Other" name="about_devicon" id="about_devicon">Other</option>
                            ...
                            <div id="fee" class="form-group">
                                <select  class="price" name="fee" id="price">
                        ...
                        <select class="leead" name="lead" id="lead" class="form-control" >
                        ...
                        <select class="lead_course"  name="lead_course" class="form-control"  value="internship" id="internship" hidden>
                    
                        @foreach($intern as $try)
                        <option name="lead_course" id="lead_course" value="{{$try->course_name}}" >{{$try->course_name}}</option>
                        @endforeach
                                            
                        </select>
                       
                        <select  class="lead_course"  name="lead_course"  class="form-control"  value="service" id="service" hidden>
                      
                        @foreach($service as $try)
                        <option name="lead_course" id="lead_course"  value="{{$try->course_name}}"  >{{$try->course_name}}</option>
                        @endforeach
                                            
                        </select>
                        
                        <select  class="lead_course" name="lead_course" class="form-control" value="course" id="course" hidden>
                      
                        @foreach($course as $try)
                        <option name="lead_course" id="lead_course" value="{{$try->course_name}}">{{$try->course_name}}</option>
                        @endforeach
                        ...
                        <div class="col-md-6">
                        <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Your DOB" id="dob" name="dob"/>
                            </div>
      </div>
                        <div class="col-md-6">
                               <div class="form-group">
                               <select name="marketer_name" id="marketer_name" class="form-control" >
    ...
    <thead>
            ...
            <th class="text-center"style="width:40%">GMAIL</th>
            <th class="text-center" style="width:30%">UNI</th>
            <th class="text-center"style="width:30%">REF</th>
            <th class="text-center"style="width:60%">Lead</th>
            <th class="text-center"style="width:30%">Marketer</th>
            <th class="text-center"style="width:30%">DEAL TELL</th>
            <th class="text-center"style="width:30%">DEAL DONE</th>
        </tr>
    </thead>
    <tbody>
    @foreach($use as $item)
...
<link rel="stylesheet"
    ...
    <head>
    <body>
    <table class="table" id="table" id="styled-table" >
    <thead>
            <th class="text-center" style="width:30%">ID</th>
            <th class="text-center" style="width:30%"> NAME</th>
            <th class="text-center"style="width:60%">CNIC</th>
            <th class="text-center"style="width:40%">Degree</th>
            <th class="text-center"style="width:60%">Lead</th>
            <th class="text-center"style="width:60%">Price</th>
            <th class="text-center"style="width:60%">Ref</th>
