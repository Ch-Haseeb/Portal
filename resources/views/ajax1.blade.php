  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="leaddata">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Leads Data</span>
          </a>
        </li>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Lead Data</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Lead Data</h6>
        </nav>
...
<div class="form">
  	...
  	@endforeach -->
                              ...
                              <select style="width: 200px" class="prod_market" name="marketer_name">
                               ...
                               <select style="width: 200px" class="p1" name="p1" hidden>

  	                          <option value="0" disabled="true" selected="true" name="p1">Fees Staus</option>
                               </select>
                       ...
                       <option value="0" disabled="true" selected="true" name="p3">Fees Staus</option>
                        ...
                        <span> Marketer Status  </span>
                        &nbsp 
                        <select style="width: 200px" class="marketer_status" name="marketer_status">

                       <option value="0" disabled="true" selected="true" name="marketer_status"> Chhose Staus Payment</option>
 
                        </select>
                     
                        <br>

                        <button type="Submit" class="btn btn-primary  float-right" name="action" id="b1" value="student">Student  Invoice</button>
...
<script type="text/javascript">
    ...
    $(document).on('change','.productname',function () {
			...
			$.ajax({
				...
				success:function(p){
					...
					op+='<option value="'+p.course_price+'">'+p.course_price+'</option>';
    ...
    $(document).on('change','.productname',function () {
			...
			$.ajax({
				...
				success:function(p){
					...
					op+='<option value="'+p.m1+'">'+p.m1+'</option>';
    ...
    $(document).on('change','.productname',function () {
			...
			$.ajax({
				type:'get',
				url:'{!!URL::to('marketer_status')!!}',
				data:{'lead_course':prod_id},
				dataType:'json',//return data will be json
				success:function(p){
					// console.log("name");
					console.log(p.marketer_status);
					 //console.log(typeof(p.n))
					...
					op+='<option value="0" selected disabled>Choose Marketer Status</option>';
					op+='<option value="'+p.marketer_status+'">'+p.marketer_status+'</option>';

					a.find('.marketer_status').html(" ");
					a.find('.marketer_status').append(op);
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body p-4 py-5 p-md-5">
		      	<h3 class="text-center mb-3">Send Gmail </h3>
