<div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="../assets/images/dashboard/1.png" alt="">
            <div class="badge-bottom"><span class="badge badge-primary"></span></div><a href="">
              <h6 class="mt-3 f-14 f-w-600">Devicon</h6></a>
            <p class="mb-0 font-roboto">Software House</p>
            ...
            <div class="main-navbar">
              ...
              <div id="mainnav">           
                <ul class="nav-menu custom-scrollbar">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="box"></i><span>Courses</span></a>
                    <ul class="nav-submenu menu-content">
                  ...
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="folder-plus"></i><span>Leads</span></a>
                    <ul class="nav-submenu menu-content">
                      <li><a href="prodview">Lead Data</a></li>
                      <li><a href="leads">Leads</a></li>
                    </ul>
                  </li>
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="edit-3"></i><span>Services</span></a>
                    <ul class="nav-submenu menu-content">
                      <li><a href="services">Service</a></li>
        
                    </ul>
                  </li>
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="cloud-drizzle"></i><span>Internship</span></a>
                    <ul class="nav-submenu menu-content">
                      <li><a href="internship">Internship</a></li>
 
                    </ul>
                  </li>
                  <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="command"></i><span>Marketer</span></a>
                    <ul class="nav-submenu menu-content">
